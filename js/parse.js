function parse() {
  chrome.storage.local.get(function(r) {
    var a = [], o = r.s.split('#'), i, l, s = {
      ...
      ntv: {id: 'ntv', source: 'http://www.ntv.com.tr/' + o[1] + '.rss', data: 'entry', title: 'title', description: 'summary', image: 'content', link: 'link'},
    ...
    $.get(s[o[0]]['source']).done(function(d) {
      ...
      chrome.storage.local.set({'a': JSON.stringify(a)});
    });
  });
}
